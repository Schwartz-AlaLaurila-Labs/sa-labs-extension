classdef SchwartzLab_Rig_A_Pstim < sa_labs.rigs.SchwartzLab_Rig_Base
    
    properties
        % properties not accessible here; have to be fed into a device to work
        rigName = 'Schwartz Lab Rig A Pstim';
        testMode = false;
    ...
    methods
        ...
        function obj = SchwartzLab_Rig_A_Pstim(delayInit)
...
%             obj.daqStreams('ScanImageShutter') = {'diport0', 2, 0};
            ...
            obj.daqStreams('PstimTrigger') = {'ai4',-1,'V'};
