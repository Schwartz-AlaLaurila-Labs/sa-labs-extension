classdef TestRig_SchwartzLab < symphonyui.core.descriptions.RigDescription
    ...
    methods
        ...
        function obj = TestRig_SchwartzLab()
            ...
            amp3 = MultiClampDevice('Amp3', 2).bindStream(daq.getStream('ANALOG_OUT.2')).bindStream(daq.getStream('ANALOG_IN.2'));
            obj.addDevice(amp3);

            amp4 = MultiClampDevice('Amp4', 2).bindStream(daq.getStream('ANALOG_OUT.3')).bindStream(daq.getStream('ANALOG_IN.3'));
            obj.addDevice(amp4);
