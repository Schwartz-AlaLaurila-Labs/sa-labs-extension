classdef (Abstract) BaseProtocol < symphonyui.core.Protocol
    ...
    properties
        ...
        scanHeadTrigger = false;        % Scanhead trigger for function imaging, added by Greg 3/5/18 #6a0ad2f525de2f8b41aa114650897c137e031096
    end
    ...
    methods
        ...
        function prepareEpoch(obj, epoch)
         ...
         function completeEpoch(obj, epoch)
            ...
            obj.addBathTempratureToEpoch(epoch)
         end
        ...
        function addBathTempratureToEpoch(obj, epoch)
            ...
            if ~isempty(controllers) && epoch.hasResponse(controllers{1})
                ...
                % Temperature readout from Warner TC-324C controller 100 mV/degree C.
