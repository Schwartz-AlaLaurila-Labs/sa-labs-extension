...
%         end
        ...
        function stim = createAmpStimulus(obj, ampName)
            ...
            gen1.tailTime =  obj.PulseTrainTime + obj.stim2Time+obj.tailTime;  %Test pulses frequency over 2 (ms)
            ...
            gen2.tailTime = (obj.PTFreq/2)*1000; %incorrect
...
%             epoch.addResponse(shutterDevice);
        ...
        function STnumPulses = get.STnumPulses(obj)
            STnumPulses = obj.PulseTrainTime/(1000/obj.STFreq);
        end
